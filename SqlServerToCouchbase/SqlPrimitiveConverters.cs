...
{
    // from: https://stackoverflow.com/questions/45848550/newtonsoft-json-jsonserializationexception-error-getting-value-from-value-on
    ...
    {
        protected override object GetValue(SqlBinary sqlValue)
        {
    ...
    {
        protected override object GetValue(SqlBoolean sqlValue)
        {
            return sqlValue.Value;
        }
    ...
    {
        protected override object GetValue(SqlByte sqlValue)
        {
            return sqlValue.Value;
        }
    ...
    {
        protected override object GetValue(SqlDateTime sqlValue)
        {
            return sqlValue.Value;
        }
    ...
    {
        protected override object GetValue(SqlDecimal sqlValue)
        {
            return sqlValue.Value;
        }
    ...
    {
        protected override object GetValue(SqlDouble sqlValue)
        {
            return sqlValue.Value;
        }
    ...
    {
        protected override object GetValue(SqlGuid sqlValue)
        {
            return sqlValue.Value;
        }
    ...
    {
        protected override object GetValue(SqlInt16 sqlValue)
        {
            return sqlValue.Value;
        }
    ...
    {
        protected override object GetValue(SqlInt32 sqlValue)
        {
            return sqlValue.Value;
        }
    ...
    {
        protected override object GetValue(SqlInt64 sqlValue)
        {
            return sqlValue.Value;
        }
    ...
    {
        protected override object GetValue(SqlMoney sqlValue)
        {
            return sqlValue.Value;
        }
    ...
    {
        protected override object GetValue(SqlSingle sqlValue)
        {
            return sqlValue.Value;
        }
    ...
    {
        protected override object GetValue(SqlString sqlValue)
        {
            return sqlValue.Value;
        }
